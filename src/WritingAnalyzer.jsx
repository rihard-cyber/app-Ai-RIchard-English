...
export default function WritingAnalyzer({ userProfile, onUpgrade }) {
  ...
  return (
    <div className="p-4 md:p-10 max-w-4xl mx-auto space-y-8 animate-in fade-in duration-500 pb-lex items-center justify-center text-white shadow-xl shadow-indigo-500/30 mb-6 transform -rotate-3 hover:rotate-0 transition-transform">
          <PenTool size={32} />
        </div>
