...
export default function WritingAnalyzer({ isPro }) {
    ...
    return (
      <div className="h-full flex items-center justify-center p-6 bg-slate-50">
        <div className="bg-white p-8 md:p-12 rounded-[3rem] shadow-2xl border border-slate-100 max-w-lg text-center animate-in zoom-in-95 duration-500">
           <div className="w-24 h-24 bg-gradient-to-tr from-blue-400 to-indigo-600 text-white rounded-3xl flex items-center justify-center mx-auto mb-8 shadow-lg shadow-indigo-500/20">
             <Crown size={48} />
           </div>
           <h2 className="text-3xl font-black text-slate-800 mb-4">Writing Analyzer PRO 👑</h2>
           <p className="text-slate-500 mb-10 text-lg leading-relaxed">
             Analisa tulisan mendalam hanya tersedia untuk pengguna Premium. Upgrade sekarang untuk mendapatkan koreksi grammar dan vocabulary profesional.
           </p>
           <button 
